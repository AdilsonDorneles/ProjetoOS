...
public class TelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Desenvolvido por Adilson Dorneles");

        jLabel3.setText("Sob a Licença GPL");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infotec/icons/gnu_logo_icon_168163.png"))); // NOI18N

        jLabel5.setText("Versão 0.01");

        jLabel6.setText("(Projeto professor José de Assis)");
